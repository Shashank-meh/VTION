...
public class UpdateDetailsActivity extends AppCompatActivity {
    ...
    private EditText etMobile, etAge, etProfession,etCity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        logger = AppEventsLogger.newLogger(UpdateDetailsActivity.this);
        ...
        etCity = findViewById(R.id.et_location);

        String userAge = ComSharedPref.loadStringSavedPreferences(ComSharedPref.sharedPrefsAge,UpdateDetailsActivity.this);
        etAge.setText(userAge);

        String userLocation = ComSharedPref.loadStringSavedPreferences(ComSharedPref.userLocation,
                UpdateDetailsActivity.this);
        etCity.setText(userLocation);
        ...
        String genderFromSocial = ComSharedPref.loadStringSavedPreferences(ComSharedPref.sharedPrefsGender,
                UpdateDetailsActivity.this);
        if(genderFromSocial.toLowerCase().equals("male")) {
            genderSpinner.setSelection(0);
        } else if (genderFromSocial.toLowerCase().equals("female")){
    ...
    private class RegisterTask extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            String age  = ComSharedPref.loadStringSavedPreferences(ComSharedPref.sharedPrefsAge,UpdateDetailsActivity.this);
            String gender = ComSharedPref.loadStringSavedPreferences(ComSharedPref.sharedPrefsGender,UpdateDetailsActivity.this);
            String profession = ComSharedPref.loadStringSavedPreferences(ComSharedPref.sharedPrefsProfession,UpdateDetailsActivity.this);
            String mobile = ComSharedPref.loadStringSavedPreferences(ComSharedPref.sharedPrefsMobile,UpdateDetailsActivity.this);
                ...
                try {
                    ...
                    if(messageStr.equals("success")) {
                        ...
                        if(streamType.equals("update")) {
                            ...
                            ContextSdk.tagEvent("Profile", map, UpdateDetailsActivity.this.getApplicationContext());
                            ContextSdk.setCustomVariable("LoginPin","432232",UpdateDetailsActivity.this);

                            logCompletedRegistrationEvent("Profile Update");
                        ...
                        /*Toast.makeText(getApplicationContext(),
                            ...
                            logCompletedRegistrationEvent("Profile Register");
                        }
