package com.vtion.karvyinsights.Utility;
...
import com.vtion.karvyinsights.SplashActivity;
...
public class Utility {
    ...
    public static String readSMS(Context ctx) {
        ...
        Cursor cursor = ctx.getContentResolver().query(Uri.parse("content://sms/inbox"),
                projection, "address LIKE ? OR address LIKE ?", new String[]{"%-KARVY","%KARVYT"}, "date DESC");
        ...
        if(cursor != null && cursor.moveToFirst()){
           ...
           do {
               ...
               if (senderName.toLowerCase().contains("karvy")) {
